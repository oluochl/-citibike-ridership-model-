Write a skeleton README.md: a one-sentence description, and a short guide to what each folder contains. You will expand it into a full write-up in Part 2.
